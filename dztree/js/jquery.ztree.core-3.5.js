...
(function($){
	...
	data = {
		...
		getNodeTitle: function(setting, node) {
			...
			//var t = setting.data.key.title === "" ? setting.data.simpleData.idKey : setting.data.key.title;
			var t = setting.data.key.title === "" ? setting.data.key.id : setting.data.key.title;
			return "" + node[t];
		},
